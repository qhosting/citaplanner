...
/**
 * Script para generar el archivo SQL con hashes de bcrypt correctos
 * Uso: node generate-seed-sql.js
 */
...
async function generateHashes() {
  console.log('🔐 Generando hashes de bcrypt...\n');
  
  const passwords = {
    admin: 'admin123',
    manager: 'manager123',
    professional: 'prof123'
  };
...
-- admin123 -> ${hashes.admin}
-- manager123 -> ${hashes.manager}
-- prof123 -> ${hashes.professional}
...
`;
  ...
  fs.writeFileSync('seed-data-with-hashes.sql', sqlContent);
  console.log('✅ Archivo SQL generado: seed-data-with-hashes.sql\n');
